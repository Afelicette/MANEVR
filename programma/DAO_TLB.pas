...
// PASTLWTR : 1.2
// File generated on 13.05.2025 19:13:51 from Type Library described below.

// ************************************************************************  //
// Type Lib: C:\Program Files\Microsoft Office\root\VFS\ProgramFilesCommonX64\Microsoft Shared\Office16\ACEDAO.DLL (1)
// LIBID: {4AC9E1DA-5BAD-4AC7-86E3-24F4CDCECA28}
// LCID: 0
// Helpfile: C:\Program Files\Microsoft Office\root\VFS\ProgramFilesCommonX64\Microsoft Shared\Office16\dao360.chm
// HelpString: Microsoft Office 16.0 Access database engine Object Library
// DepndLst: 
...
//   Error creating palette bitmap of (TTableDef) : Access violation at address 016D5407 in module 'tlib70.bpl'. Read of address 00000000
//   Error creating palette bitmap of (TField) : Access violation at address 016D5407 in module 'tlib70.bpl'. Read of address 00000000
//   Error creating palette bitmap of (TIndex) : Access violation at address 016D5407 in module 'tlib70.bpl'. Read of address 00000000
//   Error creating palette bitmap of (TQueryDef) : Access violation at address 016D5407 in module 'tlib70.bpl'. Read of address 00000000
//   Error creating palette bitmap of (TRelation) : Access violation at address 016D5407 in module 'tlib70.bpl'. Read of address 00000000
// ************************************************************************ //
// *************************************************************************//
// NOTE:                                                                      
...
const
  ...
  IID_Field3: TGUID = '{00000057-0000-0010-8000-00AA006D2EA4}';
...
const
  ...
  dbVersion150 = $00000200;
  dbVersion167 = $00000400;
...
const
  ...
  dbPagesLockedToTableLock = $00000046;
...
// Interface: Field3
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {00000057-0000-0010-8000-00AA006D2EA4}
// *********************************************************************//
  Field3 = interface(Field2)
    ['{00000057-0000-0010-8000-00AA006D2EA4}']
    function Get_Precision: Smallint; safecall;
    procedure Set_Precision(pl: Smallint); safecall;
    function Get_Scale: Smallint; safecall;
    procedure Set_Scale(pl: Smallint); safecall;
    property Precision: Smallint read Get_Precision write Set_Precision;
    property Scale: Smallint read Get_Scale write Set_Scale;
  end;
...
// *********************************************************************//
  Field3Disp = dispinterface
    ['{00000057-0000-0010-8000-00AA006D2EA4}']
    property Precision: Smallint dispid 1610940416;
    property Scale: Smallint dispid 1610940418;
    property ComplexType: ComplexType readonly dispid 1610874880;
    procedure LoadFromFile(const FileName: WideString); dispid 1610874881;
    procedure SaveToFile(const FileName: WideString); dispid 1610874882;
    property IsComplex: WordBool readonly dispid 1610874883;
